...
uint8_t icon2[512] = {
	...
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01,/* End of first line, or the top 8 pixels */
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 	
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, /* End of second line */
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, /* End of third line */
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* Last (fourth) line */
};
...
void helper_ChangeInSection(int x, int y, int status, uint8_t * icon) {
  ...
  rowRest = y % 8;      /*Number of pixels still to go down */
  pixelPlace += rowCalc * 8; /* */
  pixelPlace += x;
  /* inputValue = inputValue >> rowRest; */
  if(status == 0){ /* Clearing the bit*/
    icon[pixelPlace] &= ~(status << 7); /* &= ~(inputValue << (7 - rowRest)); */
  }
  if (status == 1) { /*Setting the bit */
    icon[pixelPlace] |= status;
  }
}
...
void changeOnePixel(int x, int y, int status) {
	...
	case 1 :
	  helper_ChangeInSection(x, y, status, icon2);
	  break;
...
int main(void) {
	...
	int j;
	for(j = 0; j < 1600000; j++) { /* Wait */
		int foo;
		foo = j +1;
		}	
	changeOnePixel(0, 0, 0);
